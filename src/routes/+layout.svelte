...
<div class="fixed bg-black top-0 left-0 right-0 bottom-full z-10 overflow-hidden" id="mainNavigation">
	<nav class="container text-white flex flex-col text-4xl sm:text-8xl pt-16 md:pt-32 gap-4">
		...
		<a href="/projects" aria-current={page.url.pathname === '/about'} class="flex items-center gap-4">
			<svg class="size-8 md:size-16" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
...
<header class="sticky top-0 h-16 md:h-32 z-10 flex items-center bg-transparent mix-blend-difference">
